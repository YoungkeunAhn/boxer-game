export const meta = {
  ...
  phases: [
    ...
    { title: 'Implement', detail: '계획대로 구현하고 check.mjs fast로 자체 검증(green까지)' },
...
커밋은 하지 마라(스테이징/커밋은 사람이 한다). 마지막에: 수정한 파일 목록, 올린 버전(schema/balance), check.mjs 최종 결과, 남은 TODO/가정, 다음 태스크 제안을 요약해 반환하라.`,
