...
| **브라우저 E2E** | `npm run e2e` | Playwright로 `docs/process/browser-smoke-checklist.md` 자동화 | UI·CSS·스토어·화면 동작 변경 시, 릴리스 직전 |
...
├─ 다 됐고 올린다                              → /deploy
└─ 출시 직전 최종 점검                         → npm run check:e2e + docs/release/release-checklist.md
```
...
- [docs/process/dev-workflow.md](dev-workflow.md) — `/dev` 사이클 상세(args·브랜치 규칙·운영 모델)
- [docs/process/git-workflow.md](git-workflow.md) — 브랜치·커밋 규칙
- [docs/release/release-checklist.md](../release/release-checklist.md) — 출시 전 점검
- [docs/process/browser-smoke-checklist.md](browser-smoke-checklist.md) — E2E가 자동화하는 항목 / 수동 항목
